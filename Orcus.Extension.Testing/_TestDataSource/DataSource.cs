    ...
    public static class DataSource
    {
        ...
        public static IList<Product> Products
        {
            get
            {
                ...
                {
                    new Product { ProductID = 1, ProductName = "Bath Rug, Soft", CategoryID = 1, UnitPrice = 24.5m },
                    new Product { ProductID = 2, ProductName = "Shower Curtain", CategoryID = 1, UnitPrice = 30.99m },
                    new Product { ProductID = 3, ProductName = "Soap Dispenser", CategoryID = 1, UnitPrice = 12.4m, OutOfStock = true },
                    new Product { ProductID = 4, ProductName = "Toilet Tissue", CategoryID = 1, UnitPrice = 15 },
                    new Product { ProductID = 5, ProductName = "Branket", CategoryID = 2, UnitPrice = 60 },
                    new Product { ProductID = 6, ProductName = "Mattress Protector", CategoryID = 2, UnitPrice = 30.4m, OutOfStock = true },
